...
import cn.com.easyerp.core.mail.MailService;
 ...
 public class RegisterValidateService
 {
   ...
   public boolean processregister(String email, HttpServletRequest request) {
     ...
     MailServer mailServer = new MailServer(systemParameter.getMail_host(), systemParameter.getMail_user(), systemParameter.getMail_addr(), systemParameter.getMail_pwd());
