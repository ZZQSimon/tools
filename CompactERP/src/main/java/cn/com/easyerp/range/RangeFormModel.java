...
import cn.com.easyerp.framework.enums.ActionType;
   ...
   extends DetailFormModel
 {
   ...
   public RangeFormModel(ActionType action, String parent, String mode, String tableName, String groupCols, List<FieldModelBase> filter, List<FieldModelBase> record, int cols, List<GridModel> grid) {
   ...
   public List<FieldModelBase> getFilter() { return this.filter; }
 
 
 
   
   public List<FieldModelBase> getRecord() { return this.record; }
 }
