...
import cn.com.easyerp.framework.enums.ActionType;
   ...
   extends FormModelBase
 {
   ...
   public void setSettingList(List<Map<String, Object>> settingList) { this.settingList = settingList; }
 
 
   
   public void setUcodeList(List<Map<String, Object>> UcodeList) { this.UcodeList = UcodeList; }
 
 
   
   public void setSubjectList(List<Map<String, Object>> SubjectList) { this.SubjectList = SubjectList; }
   ...
   public List<Map<String, Object>> getSettingList() { return this.settingList; }
 
 
   
   public List<Map<String, Object>> getUcodeList() { return this.UcodeList; }
 
 
   
   public List<Map<String, Object>> getSubjectList() { return this.SubjectList; }
   ...
   public String getTitle() { return "对照页面"; }
 }
