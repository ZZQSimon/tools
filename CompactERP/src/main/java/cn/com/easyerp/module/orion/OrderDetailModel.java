...
public class OrderDetailModel {
    ...
    public String getDistribution_satatus() {
        return this.distribution_satatus;
    }

    public void setDistribution_satatus(String distribution_satatus) {
        this.distribution_satatus = distribution_satatus;
    }
    ...
    public String export(OrionReportParam param) {
        ...
        return fillLeading(this.issue_no, leadingChar, 13) + delimiter + fillLeading(this.order_id, leadingChar, 15)
                + delimiter + fillLeading(this.manufacture_id, leadingChar, 8) + delimiter
                + fillLeading(this.device_id, leadingChar, 4) + delimiter + fillLeading(this.item_id, leadingChar, 30);
    }
}
