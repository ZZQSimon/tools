...
public class EmpInfo {
    ...
    private double allDaysAward;
    private double loss;
    private double late;
    private String is_company_deputy;
    ...
    public String getIs_company_deputy() {
        return this.is_company_deputy;
    }

    public void setIs_company_deputy(String is_company_deputy) {
        this.is_company_deputy = is_company_deputy;
    }
    ...
    public double getAllDaysAward() {
        return this.allDaysAward;
    }

    public void setAllDaysAward(double allDaysAward) {
        this.allDaysAward = allDaysAward;
    }
