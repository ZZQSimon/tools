...
import java.util.Map;
 ...
 public class Data {
   ...
   public Map<String, String> getAttrs() { return this.attrs; }
   ...
   public void addAttr(String key, String value) { this.attrs.put(key, value); }
   ...
   public void addEntry(Entry body) { this.entries.add(body); }
 }
