...
import cn.com.easyerp.framework.common.ActionResult;
 ...
 public class CustomReportController extends FormViewControllerBase {
   public static String FILTER_TABLE = ""; public static final String FILTER_BUTTON_LABEL = "Report";
   ...
   public void download(HttpServletRequest request, HttpServletResponse response, HttpSession session, @RequestParam("id") String id) {
