...
public class ImportRowModel
 {
   ...
   public String getImport_date() { return this.import_date; }
   ...
   public String getReceive_indicate_date() { return this.receive_indicate_date; }
 
 
   
   public void setReceive_indicate_date(String receive_indicate_date) { this.receive_indicate_date = receive_indicate_date; }
   ...
   public String getDeliver_date() { return this.deliver_date; }
   ...
   public String getDelivery_no() { return this.delivery_no; }
 
 
   
   public void setDelivery_no(String delivery_no) { this.delivery_no = delivery_no; }
 
 
   
   public String getReceive_warehouse() { return this.receive_warehouse; }
 
 
   
   public void setReceive_warehouse(String receive_warehouse) { this.receive_warehouse = receive_warehouse; }
 
 
   
   public String getOut_warehouse() { return this.out_warehouse; }
 
 
   
   public void setOut_warehouse(String out_warehouse) { this.out_warehouse = out_warehouse; }
   ...
   public String getExchange_rate() { return this.exchange_rate; }
   ...
   public String getExchange_type() { return this.exchange_type; }
 
 
   
   public void setExchange_type(String exchange_type) { this.exchange_type = exchange_type; }
 
 
   
   public String getHome_amount() { return this.home_amount; }
 
 
   
   public void setHome_amount(String home_amount) { this.home_amount = home_amount; }
   ...
   public String getCustomer_item_id() { return this.customer_item_id; }
 
 
   
   public void setCustomer_item_id(String customer_item_id) { this.customer_item_id = customer_item_id; }
   ...
   public String getCurrency_H() { return this.currency_H; }
 
 
   
   public void setCurrency_H(String currency_H) { this.currency_H = currency_H; }
 
 
   
   public String getAmount_H() { return this.amount_H; }
 
 
   
   public void setAmount_H(String amount_H) { this.amount_H = amount_H; }
 
 
   
   public String getAmount_D() { return this.amount_D; }
 
 
   
   public void setAmount_D(String amount_D) { this.amount_D = amount_D; }
 
 
   
   public String getCurrency_D() { return this.currency_D; }
 
 
   
   public void setCurrency_D(String currency_D) { this.currency_D = currency_D; }
 
 
   
   public String getSale_order_detail_id() { return this.sale_order_detail_id; }
 
 
   
   public void setSale_order_detail_id(String sale_order_detail_id) { this.sale_order_detail_id = sale_order_detail_id; }
   ...
   public String getVoucher_id() { return this.voucher_id; }
   ...
   public boolean isSameOrderNissan(String order_date, String receive_indicate_date, String receive_time, String receive_warehouse) {
     if (this.order_date == null || this.receive_indicate_date == null || this.receive_time == null || this.receive_warehouse == null)
     {
       return false;
     }
     if (!this.order_date.equals(order_date) || 
       !this.receive_indicate_date.equals(receive_indicate_date) || 
       !this.receive_time.equals(receive_time) || 
   ...
   public boolean isSameOrderHonda1(String deliver_date, String receive_time, String receiver_id) {
     ...
     if (!this.deliver_date.equals(deliver_date) || 
       !this.receive_time.equals(receive_time) || 
