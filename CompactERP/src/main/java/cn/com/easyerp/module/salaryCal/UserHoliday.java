...
public class UserHoliday
 {
   ...
   private String begin_time; private String end_time; private double how_long; private double percent;
   
   public void setType(String type) { this.type = type; }
 
   
   public String getBegin_date() { return this.begin_date; }
   ...
   public String getBegin_time() { return this.begin_time; }
   ...
   public double getHow_long() { return this.how_long; }
 
   
   public void setHow_long(double how_long) { this.how_long = how_long; }
