...
public class FilterData {
    ...
    public List<String> getStore_type() {
        return this.store_type;
    }

    public void setStore_type(List<String> store_type) {
        this.store_type = store_type;
    }

    public List<String> getEmployee_type() {
        return this.employee_type;
    }

    public void setEmployee_type(List<String> employee_type) {
