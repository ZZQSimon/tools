...
@Widget("importer")
public class ImporterFormModel extends FormModelBase {
    ...
    protected ImporterFormModel(List<ColumnDescribe> columns, Map<String, ColumnDescribe> keyColMap, String customerId,
            int typeId) {
    ...
    public String getTitle() {
        return Common.getDataService().getMessageText("import excel", new Object[0]);
    }
    ...
    public CustomImportResult getResult() {
        return this.result;
    }

    public void setResult(CustomImportResult result) {
        this.result = result;
    }

    public Map<String, ColumnDescribe> getKeyColMap() {
        return this.keyColMap;
    }

    public void setKeyColMap(Map<String, ColumnDescribe> keyColMap) {
