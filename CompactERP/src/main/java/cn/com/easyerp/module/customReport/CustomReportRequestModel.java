...
import cn.com.easyerp.core.view.FormRequestModelBase;
 ...
 public class CustomReportRequestModel
   extends FormRequestModelBase<CustomReportModel>
 {
   private String filterTable;
   private String type;
   private FilterRequestModel filter;
   
   public String getFilterTable() { return this.filterTable; }
 
 
   
   public void setFilterTable(String filterTable) { this.filterTable = filterTable; }
