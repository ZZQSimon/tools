...
public class ExportController extends FormViewControllerBase {
    // @Autowired
    ...
    public ModelAndView headTable(@RequestBody Map<String, Object> params) {
        try {
            ExportsModel model = new ExportsModel(null, null);
            model.setHeadList(this.exportService.queryHead((String) params.get("typeexp"), (String) params.get("start"),
                    (String) params.get("end"), (String) params.get("status")));
    ...
    public ModelAndView bodyTable(@RequestBody Map<String, Object> params) {
        try {
            ExportsModel model = new ExportsModel(null, null);
            model.setBodyList(
                    this.exportService.queryBody((String) params.get("typeexp"), (String) params.get("keyid")));
            model.settitleName(this.exportService.queryTitleName());
