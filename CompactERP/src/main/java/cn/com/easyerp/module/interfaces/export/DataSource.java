...
import java.util.Map;
 ...
 public class DataSource {
   ...
   public List<Data> getDataSet() { return this.dataSet; }
 
   
   public void setDataSet(List<Data> dataSet) { this.dataSet = dataSet; }
 
   
   public void addData(Data data) { this.dataSet.add(data); }
   ...
   public void addAttr(String key, String value) { this.attr.put(key, value); }
 }
