...
import cn.com.easyerp.module.dao.AdidasDashboardDao;
 ...
 public class AdidasDashboardController
   extends FormViewControllerBase
 {
   ...
   public ActionResult search(@RequestBody CustomReportRequestModel request) {
     ...
     List<EmployeeType> maps = this.adidasDashboardDao.countBycontion(region, store_type, employee_type, grade, store, begin_dates, end_dates);
