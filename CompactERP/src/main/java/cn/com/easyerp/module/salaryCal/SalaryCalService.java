...
public class SalaryCalService {
   ...
   private static SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd"); @Autowired
   private CheckWorkDao checkWorkDao; @Autowired
   private SalaryCalDao salaryCalDao; public List<Integer> selectWorkPlanByDate(String beginDate, String endDate) throws ParseException {
     List<Integer> list = new ArrayList<Integer>();
     Week week = this.calendarDao.findWeekPlan();
     int[] days = { week.getMonday(), week.getTuesday(), week.getWednesday(), week.getThursday(), week.getFriday(), week.getSaturday(), week.getSunday() };
   ...
   public List<CheckWorkJson> selectAttendances(List<EmpInfo> users, String beginDate, String endDate) throws ParseException {
   ...
   private List<AttendanceJson> getUserAttendance(String user_id, String beginDate, String endDate, List<Integer> list) {
   ...
   public List<EmpInfo> selectEmpIds() { return this.salaryCalDao.selectEmpIds(); }
   
   public List<UserHoliday> selectUserHoliday(String user) { return this.salaryCalDao.selectUserHoliday(user); }
   
   public List<Map<String, Object>> selectUserAddWork(String user) { return this.salaryCalDao.selectUserAddWork(user); }
   
   public Map<String, Double> selectAddWorkRule() { return this.salaryCalDao.selectAddWorkRule(); }
   
   public Map<String, Double> selectSecurityScale() { return this.salaryCalDao.selectSecurityScale(); }
   
   public void savaUserSalary(List<UserSalary> salaries) { this.salaryCalDao.savaUserSalary(salaries); }
   
   public void deleteSalary(String date) { this.salaryCalDao.deleteSalary(date); }
}