...
public interface AdidasDashboardDao {
    List<EmployeeType> countBycontion(@Param("region") List<String> paramList1,
            @Param("store_type") List<String> paramList2, @Param("employee_type") List<String> paramList3,
            @Param("grade") List<String> paramList4, @Param("store") String paramString1,
            @Param("begin_dates") String paramString2, @Param("end_dates") String paramString3);
