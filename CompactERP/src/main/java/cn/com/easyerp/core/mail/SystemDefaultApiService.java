...
public class SystemDefaultApiService {
    ...
    @ApiMethod("SEND_SMS")
    public ApiResult sendSms(@ApiParam("UUID") List<String> uuid, @ApiParam("sms_entry_id") List<String> sms_entry_id,
            @ApiParam("phone") List<String> phone, @ApiParam("sign_name") List<String> sign_name,
            @ApiParam("template_param") List<String> template_param) {
    ...
    @ApiMethod("CHECK_PASSWORD")
    public ApiResult check_password(@ApiParam("UUID") List<String> uuid, @ApiParam("pwd") List<String> pwd,
            @ApiParam("id") List<String> id, @ApiParam("domain") List<String> domain) {
        List<String> message = new ArrayList<String>();
        ...
        this.tableDeployDao.changePassword((String) uuid.get(0), (String) id.get(0), (String) pwd.get(0),
                (String) domain.get(0));
        message.add("success");
        return new ApiResult(0, message);
    }
    ...
    public ApiResult defaultSendmail(@ApiParam("UUID") List<String> uuid, @ApiParam("title") List<String> title,
            @ApiParam("context") List<String> context, @ApiParam("receivers") List<String> receivers) {
        List<String> message = new ArrayList<String>();
        try {
    ...
    public ApiResult defaultSendmessage(@ApiParam("UUID") List<String> uuid, @ApiParam("title") List<String> title,
            @ApiParam("context") List<String> context, @ApiParam("type") List<String> type,
            @ApiParam("sender") List<String> sender, @ApiParam("receivers") List<String> receivers) {
        List<String> message = new ArrayList<String>();
        try {
    ...
    public ApiResult defaultWeiXinMessage(@ApiParam("UUID") List<String> uuid, @ApiParam("user") List<String> user,
            @ApiParam("template_id") List<String> template_id, @ApiParam("param") List<String> param) {
        List<String> message = new ArrayList<String>();
    ...
    public ApiResult timingWeiXinMessage(@ApiParam("UUID") List<String> uuid,
            @ApiParam("template_id") List<String> template_id) {
        List<String> message = new ArrayList<String>();
        Map<String, Map<String, Object>> datas = new HashMap<String, Map<String, Object>>();
        ...
        for (TimmingMessageModel timing : timings) {
            try {
                ...
                this.systemDao.execTimingResult(TimmingMessageModel.PERFOMED, TimmingMessageModel.SUCCEED,
                        timing.getId());
            } catch (Exception e) {
                this.systemDao.execTimingResult(TimmingMessageModel.PERFOMED, TimmingMessageModel.FAILED,
                        timing.getId());
            }
        }
        return new ApiResult(1, message);
    ...
    public ApiResult uploadByFtpApi(@ApiParam("UUID") List<String> uuid, @ApiParam("apiName") List<String> apiName,
            @ApiParam("filePath") List<String> filePath, @ApiParam("_table") List<String> _table) {
        List<String> message = new ArrayList<String>();
        TableDescribe tab = this.dataService.getTableDesc((String) _table.get(0));
        List<DatabaseDataMap> records = this.systemDao.execDynamicProcess((String) apiName.get(0),
                (String) uuid.get(0));
        String csvFileName = "Employee_Import_" + Common.defaultDateFormat.format(new Date()).replaceAll("-", "")
                + ".txt";
        try {
    ...
    public ApiResult automatic_approve_submit(@ApiParam("UUID") List<String> uuid,
            @ApiParam("tableId") List<String> tableId, @ApiParam("dataId") List<String> dataId,
            @ApiParam("domain") List<String> domain) {
        List<String> message = new ArrayList<String>();
        ...
        for (int i = 0; i < tableId.size(); i++) {
            ...
            this.approveService.updateApproveStatus((String) tableId.get(i),
                    ((Map) data.get(i)).get(table.getIdColumns()[0]), ApproveFlow.ApproveStatus.PROGRESS);
            message.add("success");
        }
        return new ApiResult(0, message);
    }
    ...
    public ApiResult automatic_approve(@ApiParam("UUID") List<String> uuid, @ApiParam("tableId") List<String> tableId,
            @ApiParam("dataId") List<String> dataId, @ApiParam("user_Id") List<String> user_Id,
            @ApiParam("approveReason") List<String> approveReason, @ApiParam("domain") List<String> domain,
            @ApiParam("type") List<String> type) {
        ...
        for (int i = 0; i < uuid.size(); i++) {
            ...
            List<Map<String, Object>> approveData = this.approveDao.getApproveDataByTableData((String) tableId.get(i),
                    dataId.get(i));
            ...
            case "agree":
                ...
                this.approveService.approvePass(approveId, blockId, (String) tableId.get(i),
                        (String) approveReason.get(i), dataId.get(i), flowEvent, null, null, user);
                break;
            case "reject":
                flowEvent.setEvent_type(FlowEvent.EventType.REJECT_EVENT);
                this.approveService.approveReject(approveId, blockId, (String) tableId.get(i),
                        (String) approveReason.get(i), dataId.get(i), flowEvent, null, null, user);
                break;
            case "disagree":
                flowEvent.setEvent_type(FlowEvent.EventType.DISAGREE_EVENT);
                this.approveService.approveDisagree(approveId, blockId, (String) tableId.get(i),
                        (String) approveReason.get(i), dataId.get(i), flowEvent, null, null, user);
                break;
            case "hold":
                flowEvent.setEvent_type(FlowEvent.EventType.RETAIN_EVENT);
                this.approveService.approveHold(approveId, blockId, (String) tableId.get(i),
                        (String) approveReason.get(i), dataId.get(i), flowEvent, null, null, user);
                break;
            case "termination":
                flowEvent.setEvent_type(FlowEvent.EventType.TERMINATION_EVENT);
                this.approveService.approveTermination(approveId, blockId, (String) tableId.get(i),
                        (String) approveReason.get(i), dataId.get(i), flowEvent, null, null, user);
                break;
            }
        }
    ...
    public ApiResult adidas_outer_update(@ApiParam("UUID") List<String> uuid,
            @ApiParam("entry_id") List<String> entry_id) {
    ...
    public ApiResult adidas_zhongzhi_confirm(@ApiParam("UUID") List<String> uuid,
            @ApiParam("entry_id") List<String> entry_id) {
        List<String> messages = new ArrayList<String>();
        String outerDataBase = this.adidasDao.selectOuterDataBase();
        String localDataBase = this.adidasDao.selectLocalDataBase();
    ...
    public ApiResult local_zhongzhi_confirm(@ApiParam("UUID") List<String> uuid, @ApiParam("v_id") List<String> ids,
            @ApiParam("v_shop_id") List<String> shop_ids) {
        List<String> messages = new ArrayList<String>();
        String outerDataBase = this.adidasDao.selectOuterDataBase();
        String localDataBase = this.adidasDao.selectLocalDataBase();
