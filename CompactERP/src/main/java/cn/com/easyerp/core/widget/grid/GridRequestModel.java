...
import cn.com.easyerp.core.widget.grid.dt.DataTablePagingParameterModel;
   ...
   extends WidgetRequestModelBase
 {
   ...
   public DataTablePagingParameterModel getPaging() { return this.paging; }
 
 
 
   
   public void setPaging(DataTablePagingParameterModel paging) { this.paging = paging; }
 
 
 
   
   public Map<String, Integer> getReorder() { return this.reorder; }
 
 
 
   
   public void setReorder(Map<String, Integer> reorder) { this.reorder = reorder; }
   ...
   public int getIsApproveSelect() { return this.isApproveSelect; }
 
 
   
   public void setIsApproveSelect(int isApproveSelect) { this.isApproveSelect = isApproveSelect; }
   ...
   public Map<String, Object> getApproveSelectParam() { return this.approveSelectParam; }
 
 
   
   public void setApproveSelectParam(Map<String, Object> approveSelectParam) { this.approveSelectParam = approveSelectParam; }
 }
