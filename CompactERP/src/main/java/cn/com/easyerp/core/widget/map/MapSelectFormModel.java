...
import cn.com.easyerp.framework.enums.ActionType;
 ...
 @Widget("map_select")
 public class MapSelectFormModel
   extends FormModelBase
 {
   ...
   MapSelectFormModel(String parent, LinkedHashSet<String> selection, LinkedHashMap<String, String> all, String idText, String nameText) {
   ...
   public LinkedHashSet<String> getSelection() { return this.selection; }
 
 
 
   
   public LinkedHashMap<String, String> getAll() { return this.all; }
