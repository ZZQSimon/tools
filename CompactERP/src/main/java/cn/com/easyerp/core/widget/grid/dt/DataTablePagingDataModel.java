...
import cn.com.easyerp.core.widget.grid.RecordModel;
 ...
 public class DataTablePagingDataModel
 {
   ...
   public DataTablePagingDataModel(DataTablePagingParameterModel paging) { this.draw = paging.getDraw(); }
   ...
   public int getRecordsTotal() { return this.recordsTotal; }
   ...
   public int getRecordsFiltered() { return this.recordsFiltered; }
