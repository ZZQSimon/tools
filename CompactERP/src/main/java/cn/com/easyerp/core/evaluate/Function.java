...
public class Function {
            ...
            if (values[0].equals(((ChildModel) child.getValue()).getTableName())) {
                ...
                for (int i = 0; i < childrenDatas.size(); i++) {
                    if (!"delete".equals(((DataModel) childrenDatas.get(i)).getStatus())) {
                        ...
                        Object value = ((FieldModelBase) ((DataModel) childrenDatas.get(i)).getData().get(values[1]))
                                .getValue();
                        if (value == null) {
    ...
    public String uniqueCountFunction(String funVal, Model cacheModel) {
        return "";
    }
    ...
    public String dateTextFunction(String funVal, Model cacheModel) {
        return "";
    }

    public String origFunction(String funVal, Model cacheModel) {
        return "";
    }

    public String dictFunction(String funVal, Model cacheModel) {
        return "";
    }

    public String domainKeyFunction(String funVal, Model cacheModel) {
        return this.cacheService.getDomainKey();
    }
}
