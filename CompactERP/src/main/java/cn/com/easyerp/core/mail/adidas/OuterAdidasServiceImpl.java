...
@Service
public class OuterAdidasServiceImpl implements OuterAdidasService {
    // @Autowired
    ...
    public List<EntryManage> updateAdidasData(List<String> uuid, List<EntryManage> list, String outerDataBase,
    ...
    @Transactional(propagation = Propagation.REQUIRES_NEW)
    public List<EntryManage> updateAdidasDataByZhongZhi(List<String> uuid, List<EntryManage> manageList,
            String outerDataBase, String localDataBase) {
        ...
        try {
            ...
            for (EntryManage entryManage : manageList) {
                ...
                if ("1".equals(entryManage.getZhongzhi_flag())) {
                    ...
                    List<Map<String, Object>> approveData = this.approveDao
                            .getApproveDataByTableData((String) tableId.get(0), dataId.get(0));
                    for (Map<String, Object> waitdata : approveData) {
                        ...
                        if (nodeUser != null && nodeUser.toString().equals("CIICLOCAL")) {
                            ...
                            this.systemDefaultApiService.automatic_approve(uuid, tableId, dataId, user, reason, domain,
                                    type);
                            break;
                        }
                    }
