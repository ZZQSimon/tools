...
public class MatterDeskTopModel extends WidgetModelBase {
    ...
    public List<OpRecordModel> getMatterDesk() {
        return this.matterDesk;
    }

    public void setMatterDesk(List<OpRecordModel> matterDesk) {
        this.matterDesk = matterDesk;
    }
