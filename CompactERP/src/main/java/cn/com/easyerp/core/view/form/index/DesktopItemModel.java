...
public class DesktopItemModel extends WidgetModelBase {
    private String id;
    private String name;
    ...
    public String getDate_reminder_id() {
        return this.date_reminder_id;
    }

    public void setDate_reminder_id(String date_reminder_id) {
        this.date_reminder_id = date_reminder_id;
    }
