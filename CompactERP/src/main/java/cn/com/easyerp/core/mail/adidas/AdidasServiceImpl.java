...
@Service
public class AdidasServiceImpl implements AdidasService {
    @Autowired
    ...
    @Transactional(propagation = Propagation.REQUIRES_NEW)
    public List<String> updateDataByEntryManage(List<String> uuid, List<ManageVO> idList, String outerDataBase,
    ...
    @Transactional(propagation = Propagation.REQUIRES_NEW)
    public List<String> adidasZhongZhiConfirm(List<String> uuid, List<ManageVO> voList, String outerDataBase,
            String localDataBase) {
        List<String> messages = new ArrayList<String>();
        ...
        this.dxRoutingDataSource.setActiveDomainKey(localDataBase);
        List<EntryManage> result = this.outerAdidasService.updateAdidasDataByZhongZhi(uuid, manageList, outerDataBase,
                localDataBase);
        if (result.size() <= 0) {
