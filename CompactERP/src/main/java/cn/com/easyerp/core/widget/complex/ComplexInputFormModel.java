...
@Widget("complex")
public class ComplexInputFormModel extends TableBasedFormModel {
    private ComplexColumnDescribe desc;
    private String column;
    private List<String> columns;
    private GridModel grid;

    protected ComplexInputFormModel(ActionType action, String parent, String tableName, String column,
            List<String> columns, ComplexColumnDescribe desc, GridModel grid) {
    ...
    @JsonIgnore
    public ComplexColumnDescribe getDesc() {
        return this.desc;
    }
