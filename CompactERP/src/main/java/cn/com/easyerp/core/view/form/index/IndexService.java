...
public class IndexService {
    ...
    public ShortModel selectShortList(String owner, String id) {
        return this.indexDao.selectShortList(owner, id);
    }

    public DeskModel selectChartList(String owner, String id) {
        return this.indexDao.selectChartList(owner, id);
    }
    ...
    public Map<String, Object> getReList(String owner, String id) {
        return this.indexDao.getReList(owner, id);
    }

    public String getValueBySql(String sql) {
        return this.indexDao.getValueBySql(sql);
    }

    public List<Map<String, Object>> getSuserList(String tableId, String column_name, String name_column, String id,
            String type) {
        return this.indexDao.getSuserList(tableId, column_name, name_column, id, type);
    }
