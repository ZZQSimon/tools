...
import cn.com.easyerp.framework.enums.ActionType;
   ...
   extends FormModelBase
 {
   ...
   public String getInterior_logo() { return this.interior_logo; }
 
   
   public void setInterior_logo(String interior_logo) { this.interior_logo = interior_logo; }
 
   
   public String getSysLogo() { return this.sysLogo; }
 
   
   public void setSysLogo(String sysLogo) { this.sysLogo = sysLogo; }
 
   
   public String getSysCompanyName() { return this.sysCompanyName; }
 
   
   public void setSysCompanyName(String sysCompanyName) { this.sysCompanyName = sysCompanyName; }
   ...
   public IndexModel() { super(ActionType.view, null); }
 
 
   
   public int getHeightY() { return this.heightY; }
 
 
 
   
   public List<Map<String, Object>> getCommonDesk() { return this.commonDesk; }
 
 
 
   
   public List<Map<String, Object>> getPersonDesk() { return this.personDesk; }
   ...
   public Map<String, DesktopListModel> getListMap() { return this.listMap; }
 
 
 
   
   public void setListMap(Map<String, DesktopListModel> listMap) { this.listMap = listMap; }
   ...
   public Map<String, List<AuthDetails.UserMenu>> getMobileMenu() { return this.mobileMenu; }
 
   
   public void setMobileMenu(Map<String, List<AuthDetails.UserMenu>> mobileMenu) { this.mobileMenu = mobileMenu; }
 
   
   public Map<String, Object> getApproveParam() { return this.approveParam; }
 
   
   public void setApproveParam(Map<String, Object> approveParam) { this.approveParam = approveParam; }
 
 
   
   public Map<String, Object> getEmailDetail() { return this.emailDetail; }
 
 
   
   public void setEmailDetail(Map<String, Object> emailDetail) { this.emailDetail = emailDetail; }
 
 
   
   public int getApproveFlushTime() { return this.approveFlushTime; }
 
 
   
   public void setApproveFlushTime(int approveFlushTime) { this.approveFlushTime = approveFlushTime; }
 }
