...
public class OpRecordModel extends RecordModel {
    ...
    public OpRecordModel(List<FieldModelBase> fields) {
        super(fields);
    }
    ...
    public String getDisp_table_id() {
        return this.disp_table_id;
    }

    public void setDisp_table_id(String disp_table_id) {
        this.disp_table_id = disp_table_id;
    }
