 ...
 public class MailService
 {
   ...
   public boolean send(MailDescribe mail) {
     ...
     if (cache == null) {
       ...
       MailServer mailServer = new MailServer(param.getMail_host(), param.getFtp_user(), param.getMail_addr(), param.getMail_pwd());
   ...
   public boolean sendHtmlEmail(MailDescribe mail) {
     ...
     if (cache == null) {
       SystemParameter param = this.systemDao.selectSystemParam_master();
       MailServer mailServer = new MailServer(param.getMail_host(), param.getMail_user(), param.getMail_addr(), param.getMail_pwd());
