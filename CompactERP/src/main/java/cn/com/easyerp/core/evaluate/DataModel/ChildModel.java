...
public class ChildModel {
    ...
    public List<DataModel> getChildrenDatas() {
        return this.childrenDatas;
    }

    public void setChildrenDatas(List<DataModel> childrenDatas) {
        this.childrenDatas = childrenDatas;
    }

    public Map<String, ChildModel> getChildren() {
        return this.children;
    }

    public void setChildren(Map<String, ChildModel> children) {
