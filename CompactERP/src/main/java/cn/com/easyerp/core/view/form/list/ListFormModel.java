...
@Widget("list")
public class ListFormModel extends FormWithFilterModel {
    ...
    public ListFormModel(ActionType action, String parent, String tableName, FilterModel filter, GridModel grid,
