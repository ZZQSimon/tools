 ...
 public class MessageDescribe
 {
   ...
   public MessageDescribe() { this.send_id = getUUID(); }
 
   
   public String getReceive_id() { return this.receive_id; }
 
   
   public void setReceive_id(String receive_id) { this.receive_id = receive_id; }
 
   
   public String getSend_id() { return this.send_id; }
 
   
   public void setSend_id(String send_id) { this.send_id = send_id; }
 
   
   public Date getSend_date() { return this.send_date; }
   ...
   public String getUUID() { return Long.toHexString(System.currentTimeMillis()); }
 }
