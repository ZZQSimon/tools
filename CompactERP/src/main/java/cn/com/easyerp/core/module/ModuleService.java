...
public class ModuleService {
   ...
   private static final HashMap<LogLevel, Level> levelMapping = new HashMap<>(LogLevel.values().length); static  {
   ...
   public Set<String> getModuleJs() { return this.js; }
 
 
 
   
   public Set<String> getModuleCss() { return this.css; }
 }
