...
import cn.com.easyerp.core.widget.WidgetModelBase;
   ...
   extends WidgetModelBase
 {
   ...
   public StdGridModel(String table) { this.table = table; }
   ...
   public void setRecords(List<? extends RecordModel> records) { setRecords(records, true); }
   ...
   public void reset() { setRecords(null); }
   ...
   public String idPrefix() { return "g"; }
   ...
   public String getWidgetType() { return "grid"; }
 }
