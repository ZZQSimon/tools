...
public class DetailRequestModel extends TableFormRequestModel<DetailFormModel> {
    ...
    public ViewDataMap getCalendarColorParam() {
        return this.calendarColorParam;
    }

    public void setCalendarColorParam(ViewDataMap calendarColorParam) {
        this.calendarColorParam = calendarColorParam;
    }

    public ViewDataMap getCalendarColorStatus() {
        return this.calendarColorStatus;
    }

    public void setCalendarColorStatus(ViewDataMap calendarColorStatus) {
        this.calendarColorStatus = calendarColorStatus;
    }
    ...
    public int getIsSaveAndSubmit() {
        return this.isSaveAndSubmit;
    }

    public void setIsSaveAndSubmit(int isSaveAndSubmit) {
