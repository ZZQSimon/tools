...
@Widget("filter")
public class FormWithFilterModel extends TableBasedFormModel {
    private FilterModel filter;

    protected FormWithFilterModel(ActionType action, String parent, String tableName) {
        this(action, parent, tableName, null);
    }
