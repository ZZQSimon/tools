...
public interface AdidasService {
  ...
  List<String> updateDataByEntryManage(List<String> paramList1, List<ManageVO> paramList2, String paramString1, String paramString2);
  
  List<String> adidasZhongZhiConfirm(List<String> paramList1, List<ManageVO> paramList2, String paramString1, String paramString2);
