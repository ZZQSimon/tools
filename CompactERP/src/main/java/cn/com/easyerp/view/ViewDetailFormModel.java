...
@Widget("detail")
public class ViewDetailFormModel extends DetailFormModel {
    public static final String editUrl = "/view/edit.view";
    public static final String nextUrl = "/view/next.view";

    public ViewDetailFormModel(ActionType action, String parent, String tableName, List<FieldModelBase> fields,
            List<GridModel> children, int cols) {
        super(action, parent, tableName, fields, children, cols);
    }
