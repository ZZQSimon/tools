...
public class ViewListFormModel extends ListFormModel {
    ...
    public ViewListFormModel(String parent, String tableName, FilterModel filter, GridModel grid,
            Set<TableViewStyle.Button> hideButtons, boolean load, boolean control) {
        super(ActionType.view, parent, tableName, filter, grid, hideButtons, load, control);
    }
