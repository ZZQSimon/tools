...
@Widget("operation")
public class OperationFormModel extends DetailFormModel {
    ...
    public OperationFormModel(ActionType action, String parent, TriggerDescribe tableAction, String column,
    ...
    public OperationFormModel(ActionType action, String parent, TriggerDescribe tableAction, String column,
            List<FieldModelBase> fields, String tableName) {
