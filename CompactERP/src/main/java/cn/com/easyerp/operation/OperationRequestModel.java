...
import cn.com.easyerp.core.cache.TriggerDescribe;
 ...
 public class OperationRequestModel
 {
   ...
   public ApiRequestParam getParam() { return this.param; }
 
 
 
   
   public void setParam(ApiRequestParam param) { this.param = param; }
 
 
 
   
   public Map<String, String> getNewState() { return this.newState; }
 
 
 
   
   public void setNewState(Map<String, String> newState) { this.newState = newState; }
   ...
   public List<Map<String, Object>> getOutInterfaceParam() { return this.outInterfaceParam; }
 
 
   
   public void setOutInterfaceParam(List<Map<String, Object>> outInterfaceParam) { this.outInterfaceParam = outInterfaceParam; }
 }
