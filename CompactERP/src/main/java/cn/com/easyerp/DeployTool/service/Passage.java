...
public class Passage
 {
   ...
   public String getFrontUpdated() { return this.frontUpdated; }
   private String filter_tables; private String filter_sql; private int has_append; private String frontInsert; private String frontDeleted; private String frontUpdated;
   
   public void setFrontUpdated(String frontUpdated) { this.frontUpdated = frontUpdated; }
 
   
   public String getFrontInsert() { return this.frontInsert; }
 
   
   public void setFrontInsert(String frontInsert) { this.frontInsert = frontInsert; }
 
   
   public String getFrontDeleted() { return this.frontDeleted; }
 
   
   public void setFrontDeleted(String frontDeleted) { this.frontDeleted = frontDeleted; }
   ...
   public int getHas_append() { return this.has_append; }
 
   
   public void setHas_append(int has_append) { this.has_append = has_append; }
 }
