...
public class AddTableDeploy {
    ...
    private Map<String, TriggerDeploy> triggers = null;
    private Map<String, Map<String, FlowEvent>> approveBlockEvent;
    private ApproveBlockEvent submitEvent;
    private Map<String, ColumnDeploy> cRUDColumns;
    private Map<String, TriggerDeploy> deleteTrigger;
    ...
    public List<CustomLayout> getCustomLayout() {
        return this.customLayout;
    }

    public void setCustomLayout(List<CustomLayout> customLayout) {
    ...
    public int getOrderRuleChange() {
        return this.orderRuleChange;
    }

    public void setOrderRuleChange(int orderRuleChange) {
        this.orderRuleChange = orderRuleChange;
    }

    public int getCheckRuleChange() {
        return this.checkRuleChange;
    }

    public void setCheckRuleChange(int checkRuleChange) {
        this.checkRuleChange = checkRuleChange;
    }

    public int getRendersChange() {
        return this.rendersChange;
    }

    public void setRendersChange(int rendersChange) {
        this.rendersChange = rendersChange;
    }

    public int getAutoGenChange() {
        return this.autoGenChange;
    }

    public void setAutoGenChange(int autoGenChange) {
        this.autoGenChange = autoGenChange;
    }

    public Map<String, TriggerDeploy> getDeleteTrigger() {
        return this.deleteTrigger;
    }

    public void setDeleteTrigger(Map<String, TriggerDeploy> deleteTrigger) {
        this.deleteTrigger = deleteTrigger;
    }

    public Map<String, TriggerDeploy> getTriggers() {
        return this.triggers;
    }

    public void setTriggers(Map<String, TriggerDeploy> triggers) {
        this.triggers = triggers;
    }

    public List<ColumnDeploy> getColumns() {
        return this.columns;
    }

    public void setColumns(List<ColumnDeploy> columns) {
        this.columns = columns;
    }

    public Map<String, ColumnDeploy> getColumnMap() {
        return this.columnMap;
    }

    public void setColumnMap(Map<String, ColumnDeploy> columnMap) {
        this.columnMap = columnMap;
    }

    public Map<String, AutoGenDeploy> getAutoGens() {
        return this.autoGens;
    }

    public void setAutoGens(Map<String, AutoGenDeploy> autoGens) {
        this.autoGens = autoGens;
    }
    ...
    public String getMb_block_view_style() {
        return this.mb_block_view_style;
    }

    public void setMb_block_view_style(String mb_block_view_style) {
        this.mb_block_view_style = mb_block_view_style;
    }

    public String getPc_block_view_style() {
        return this.pc_block_view_style;
    }

    public void setPc_block_view_style(String pc_block_view_style) {
        this.pc_block_view_style = pc_block_view_style;
    }
    ...
    public void setTabs(List<TableTabDescribe> tabs) {
        this.tabs = tabs;
    }

    public Map<ActionType, TableDescribe.TableActionCondition> getAction_condition() {
        return this.action_condition;
    }

    public void setAction_condition(Map<ActionType, TableDescribe.TableActionCondition> action_condition) {
    ...
    public void setRenders(List<TableRenderModel> renders) {
    ...
    public void setLinkedColumns(List<ColumnDescribe> linkedColumns) {
    ...
    public void setViewStyle(TableViewStyle viewStyle) {
    ...
    public void setComplexColumns(List<ColumnDescribe> complexColumns) {
        this.complexColumns = complexColumns;
    }
    ...
    public List<TriggerDeploy> getListTriggers() {
        return this.listTriggers;
    }

    public void setListTriggers(List<TriggerDeploy> listTriggers) {
        this.listTriggers = listTriggers;
    }

    public Map<String, Map<String, FlowEvent>> getApproveBlockEvent() {
        return this.approveBlockEvent;
    }

    public void setApproveBlockEvent(Map<String, Map<String, FlowEvent>> approveBlockEvent) {
