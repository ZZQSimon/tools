     ...
     try {
       ...
       if (passageRowList.size() > 0) {
         for (PassageRow passageRow : passageRowList) {
           if (passageRowMap.get(passageRow.getPassage_id()) == null || ((List)passageRowMap.get(passageRow.getPassage_id())).size() == 0) {
       ...
       if (passageRowFormulaList.size() > 0) {
         for (PassageRowFormula passageRowFormula : passageRowFormulaList) {
           if (passageRowFormulaMap.get(passageRowFormula.getPassage_row_id()) == null || ((List)passageRowFormulaMap
             .get(passageRowFormula.getPassage_row_id())).size() == 0) {
