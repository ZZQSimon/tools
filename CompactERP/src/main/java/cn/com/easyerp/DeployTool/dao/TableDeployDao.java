...
public interface TableDeployDao {
    ...
    void addCheckRule(@Param("checkRules") List<TableCheckRuleDescribe> paramList,
            @Param("tableName") String paramString);
    ...
    void changePassword(@Param("uuid") String paramString1, @Param("id") String paramString2,
            @Param("pwd") String paramString3, @Param("domain") String paramString4);
}
