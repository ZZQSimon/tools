...
public class DashboardRequestModel extends FormRequestModelBase<DashboardModel> {
    ...
    public DashboardDescribe getDashboard() {
        return this.dashboard;
    }

    public void setDashboard(DashboardDescribe dashboard) {
    ...
    public List<SubscribeDescribe> getSubscribes() {
        return this.subscribes;
    }

    public void setSubscribes(List<SubscribeDescribe> subscribes) {
