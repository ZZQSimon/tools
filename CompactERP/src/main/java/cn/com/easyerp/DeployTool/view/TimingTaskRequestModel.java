...
public class TimingTaskRequestModel extends FormRequestModelBase<TimingTaskModel> {
    ...
    public List<TimeTaskDescribe> getSaveTimingTask() {
        return this.saveTimingTask;
    }

    public void setSaveTimingTask(List<TimeTaskDescribe> saveTimingTask) {
        this.saveTimingTask = saveTimingTask;
    }
