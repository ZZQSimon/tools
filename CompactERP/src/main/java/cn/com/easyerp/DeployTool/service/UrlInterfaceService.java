...
public class UrlInterfaceService {
    ...
    public void CRUDUrlInterface(UrlInterfaceRequestModel request) {
        if (request.getEditUrlInterfaceMap() != null && request.getEditUrlInterfaceMap().size() != 0) {
        ...
        if (request.getAddUrlInterfaceMap() != null && request.getAddUrlInterfaceMap().size() != 0) {
        ...
        if (request.getDeleteUrlInterfaceMap() != null && request.getDeleteUrlInterfaceMap().size() != 0) {
    ...
    private void editUrlInterface(UrlInterfaceDescribe urlInterface) {
        ...
        if (urlInterface.getUrlParam() != null && urlInterface.getUrlParam().size() != 0) {
            ...
            for (Map.Entry<String, ColumnDescribe> entry : urlParam.entrySet()) {
                ...
                if ("".equals(column.getI18n().getInternational_id())
                        || column.getI18n().getInternational_id() == null) {
                ...
                if (column.getColumnChange() == 1) {
                    ...
                    this.urlInterfaceDao.updateColumn(column);
                    continue;
                }
    ...
    private void createProd(UrlInterfaceDescribe urlInterface) {
        ...
        } else if (!"".equals(urlInterface.getProdSql()) && !";".equals(String
                .valueOf(urlInterface.getProdSql().trim().charAt(urlInterface.getProdSql().trim().length() - 1)))) {
