...
public class MenuDeployRequestModel extends FormRequestModelBase<MenuDeployModel> {
    ...
    public Map<String, List<MenuDeployDetails>> getMenuDeploySave() {
        return this.menuDeploySave;
    }

    public void setMenuDeploySave(Map<String, List<MenuDeployDetails>> menuDeploySave) {
        this.menuDeploySave = menuDeploySave;
    }
