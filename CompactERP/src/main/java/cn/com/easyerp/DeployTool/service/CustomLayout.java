...
public class CustomLayout {
    ...
    private int special_column_type;
    private String special_column_value;
    ...
    public int getSpecial_column_type() {
        return this.special_column_type;
    }

    public void setSpecial_column_type(int special_column_type) {
        this.special_column_type = special_column_type;
    }

    public String getSpecial_column_value() {
        return this.special_column_value;
    }

    public void setSpecial_column_value(String special_column_value) {
        this.special_column_value = special_column_value;
    }
    ...
    public String getFont_spacing() {
        return this.font_spacing;
    }

    public void setFont_spacing(String font_spacing) {
    ...
    public String getBorder_line() {
        return this.border_line;
    }

    public void setBorder_line(String border_line) {
