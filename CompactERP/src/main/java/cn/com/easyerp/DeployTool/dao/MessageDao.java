...
public interface MessageDao {
    List<MessageDescribe> getMessageByType(@Param("type") String paramString1, @Param("pageNumber") int paramInt1,
            @Param("pageSize") int paramInt2, @Param("receiver") String paramString2);
    ...
    void addReceiveMessage(@Param("message") MessageDescribe paramMessageDescribe,
            @Param("receive_id") String paramString);
}
