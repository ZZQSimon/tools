...
public interface DictionaryDao {
    List<DictionaryDetails> selectDictionary(@Param("languageId") String paramString1,
            @Param("userId") String paramString2);

    List<DictionaryDetails> retrieveDictionary(@Param("retrieveValue") String paramString1,
            @Param("languageId") String paramString2, @Param("userId") String paramString3);
