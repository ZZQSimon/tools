...
import cn.com.easyerp.core.view.FormRequestModelBase;
 ...
 public class FunctionPointRequestModel extends FormRequestModelBase<FunctionPointModel> {
   ...
   public List<FunctionPoint> getUpdated() { return this.updated; }
 
   
   public void setUpdated(List<FunctionPoint> updated) { this.updated = updated; }
   ...
   public List<FunctionPoint> getUpdate() { return this.updated; }
 
   
   public void setUpdate(List<FunctionPoint> update) { this.updated = update; }
 
   
   public List<FunctionPoint> getDeleted() { return this.deleted; }
 
   
   public void setDeleted(List<FunctionPoint> deleted) { this.deleted = deleted; }
 }
