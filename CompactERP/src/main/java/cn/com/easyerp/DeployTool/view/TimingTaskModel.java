...
@Widget("timingTask")
public class TimingTaskModel extends FormModelBase {
    private List<TimeTaskDescribe> timingTask;

    public List<TimeTaskDescribe> getTimingTask() {
        return this.timingTask;
    }

    public void setTimingTask(List<TimeTaskDescribe> timingTask) {
        this.timingTask = timingTask;
    }

    protected TimingTaskModel(String parent) {
