...
public interface InternationalDao {
  ...
  List<International> selectLikeInternational(@Param("params") String paramString, @Param("start") Integer paramInteger1, @Param("end") Integer paramInteger2);
  
  int countInternational();
  
  List<International> retrievalInter(@Param("retrievalValue") String paramString1, @Param("language_id") String paramString2);
  ...
  void I18NReplace(@Param("findContext") String paramString1, @Param("replaceWith") String paramString2, @Param("scope") String paramString3);
