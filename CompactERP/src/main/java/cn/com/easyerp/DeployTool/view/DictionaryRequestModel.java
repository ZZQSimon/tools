...
public class DictionaryRequestModel extends FormRequestModelBase<DictionaryModel> {
    ...
    public List<DictionaryAddDetails> getDictionaryAdd() {
        return this.dictionaryAdd;
    }

    public void setDictionaryAdd(List<DictionaryAddDetails> dictionaryAdd) {
        this.dictionaryAdd = dictionaryAdd;
    }
}
