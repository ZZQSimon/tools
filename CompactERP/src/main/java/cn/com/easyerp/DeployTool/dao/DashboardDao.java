...
public interface DashboardDao {
  ...
  List<DatabaseDataMap> getTableList(@Param("table") String paramString1, @Param("where") String paramString2, @Param("authCondition") String paramString3, @Param("orderBy") String paramString4, @Param("defaultCount") int paramInt);
  ...
  void addSubscribe(@Param("dashboard_id") String paramString1, @Param("subscribe_id") String paramString2, @Param("subscriber") String paramString3, @Param("subscribe_status") String paramString4);
  
  List<DatabaseDataMap> getSubscribesBysubscriber(@Param("subscriber") String paramString);
  
  int updateSubscribe(@Param("sub") SubscribeDescribe paramSubscribeDescribe, @Param("subscriber") String paramString);
  
  int updateSubscribesSeq(@Param("sub") SubscribeDescribe paramSubscribeDescribe, @Param("subscriber") String paramString);
