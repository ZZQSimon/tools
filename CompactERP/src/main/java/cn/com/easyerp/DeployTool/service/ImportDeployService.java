...
public class ImportDeployService {
    ...
    public ImportDeployModel getImportDeploy(String tableName) {
        return this.importDeployDao.getImportDeploy(tableName);
    }
    ...
    public Set<String> getExcelHead(FileItem fi, String suffix) {
        Set<String> rec = null;
        try (InputStream is = fi.getInputStream(); HSSFWorkbook hSSFWorkbook = new HSSFWorkbook(is);) {
            // HSSFWorkbook hSSFWorkbook = "xls".equals(suffix) ? new HSSFWorkbook(is) : new
            // XSSFWorkbook(is);
            Sheet sheet = null;
            int start = 0;
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void createImportTemplate(ImportDeployRequestModel request)
    ...
    private String createImportProcedure(Map<String, String> mapper, String tableName) {
        ...
        String sql = " DROP PROCEDURE IF EXISTS " + proName + ";\n" + " CREATE PROCEDURE " + proName
                + "(IN uuid varchar(50),IN user_id varchar(20))\n" + " BEGIN\n" + " DECLARE buildSql varchar(5000);\n"
    ...
    private String buildColumnSQL(ColumnDescribe column) {
        ...
        case 6:
            return "`" + column.getColumn_name() + "` varchar("
                    + ((column.getMax_len() == null) ? "20" : column.getMax_len()) + ")";
        case 1:
        case 7:
        case 8:
        case 9:
        ...
        case 15:
            return "`" + column.getColumn_name() + "` varchar("
                    + ((column.getMax_len() == null) ? "50" : column.getMax_len()) + ")";
        case 2:
        case 5:
    ...
    private String getI18nID() {
        return Common.generateShortUuid();
    }

    public String getTableIdByBatchId(String batchId) {
        return this.importDeployDao.getTableIdByBatchId(batchId);
    }

    public void callSysImportApi(String sysApiName, String userId) {
        this.importDeployDao.callSysImportApi(sysApiName, userId);
    }
}
