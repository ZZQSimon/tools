...
public class InternationalRequestModel extends FormRequestModelBase<InternationalModel> {
    ...
    public List<International> getInsert() {
        return this.insert;
    }

    public void setInsert(List<International> insert) {
        this.insert = insert;
    }

    public List<International> getUpdate() {
        return this.update;
    }

    public void setUpdate(List<International> update) {
        this.update = update;
    }

    public List<International> getDeleted() {
        return this.deleted;
    }

    public void setDeleted(List<International> deleted) {
        this.deleted = deleted;
    }

    public String getFindContext() {
        return this.findContext;
    }

    public void setFindContext(String findContext) {
