...
import cn.com.easyerp.framework.enums.ActionType;
   ...
   extends FormViewControllerBase
 {
   ...
   public ModelAndView view(@RequestBody FormRequestModelBase data) {
     FieldWithRepresentationModel NewPassword = new FieldWithRepresentationModel("m_user", "_password", "NewPassword", "********");
     
     FieldWithRepresentationModel OldPassword = new FieldWithRepresentationModel("m_user", "_password", "OldPassword", "********");
     
     FieldWithRepresentationModel RepeatPassword = new FieldWithRepresentationModel("m_user", "_password", "RepeatPassword", "********");
 
     
     PasswordFormModel form = new PasswordFormModel(ActionType.edit, data.getParent(), NewPassword, OldPassword, RepeatPassword, "m_user");
   ...
   public ActionResult update(@RequestBody Map<String, String> param, @PathVariable String form_id) {
     PasswordFormModel form = (PasswordFormModel)ViewService.fetchFormModel(form_id);
