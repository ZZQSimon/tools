...
public class PassageCatalogModel {
    ...
    public PassageCatalogModel(String id, List<FieldModelBase> fields, Map<String, List<Map<String, Object>>> catalogs,
    ...
    public Map<String, List<Map<String, Object>>> getCatalogs() {
