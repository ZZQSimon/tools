...
import cn.com.easyerp.core.view.TableFormRequestModel;
 ...
 public class PassageRequestModel
   extends TableFormRequestModel
 {
   ...
   public List<List<Map<String, Object>>> getExportData() { return this.exportData; }
 
 
 
   
   public void setExportData(List<List<Map<String, Object>>> exportData) { this.exportData = exportData; }
   ...
   public List<Map<String, Object>> getPkeys() { return this.pkeys; }
 
 
 
   
   public void setPkeys(List<Map<String, Object>> pkeys) { this.pkeys = pkeys; }
 }
