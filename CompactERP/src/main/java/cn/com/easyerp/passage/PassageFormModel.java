...
@Widget("passage")
public class PassageFormModel extends TableBasedFormModel {
    ...
    public PassageFormModel(ActionType action, String passageId, String tableName, String mainIds, String type,
            boolean hasAppend, boolean searchAll, String startDate, String endDate, String groupCols,
            List<ColumnDescribe> headColumns, List<FieldModelBase> searchConditions,
            Map<String, String> searchConditionsKey, String filterSql, List<String> headPassColumns, String saveMode) {
    ...
    public List<ColumnDescribe> getHeadColumns() {
        return this.headColumns;
    }

    public List<String> getHeadPassColumns() {
        return this.headPassColumns;
    }

    public List<FieldModelBase> getSearchConditions() {
        return this.searchConditions;
    }

    public Map<String, String> getSearchConditionsKey() {
        return this.searchConditionsKey;
    }
    ...
    @JsonIgnore
    public List<Long> getHeadPassColumns_date() {
        return this.headPassColumns_date;
    }

    @JsonIgnore
    public void setHeadPassColumns_date(List<Long> headPassColumns_date) {
        this.headPassColumns_date = headPassColumns_date;
    }
    ...
    private FilterModel createFilter(String tableName, List<FieldModelBase> searchConditions, boolean hasAppend) {
        ...
        for (ColumnDescribe column : tableDesc.getColumns()) {
            ...
            for (FieldModelBase field : searchConditions) {
                if (tableName.equals(field.getTable()) && columnName.equals(field.getColumn())) {
