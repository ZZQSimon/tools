...
@Widget("ag")
public class AutoGenerateFormModel extends FormWithFilterModel {
    ...
    protected AutoGenerateFormModel(String parent, String tableName, AutoGenTableDesc ag, FilterModel filter,
            StdGridModel grid, boolean hasSum, List<String> columns, Set<String> inputs) {
