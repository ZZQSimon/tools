...
import cn.com.easyerp.framework.enums.ActionType;
 ...
 @Widget("agSingle")
 public class AutoGenerateSingleModeFormModel
   extends DetailFormModel
 {
   private AutoGenTableDesc ag;
   
   public AutoGenerateSingleModeFormModel(String parent, String tableName, List<FieldModelBase> fields, AutoGenTableDesc ag) {
