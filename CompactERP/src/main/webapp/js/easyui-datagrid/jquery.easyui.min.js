...
(function ($) {
    ...
    function _43(e) {
        ...
        var _45 = _44.options;
        var _46 = $(".__droppable:visible").filter(function () {
            return e.data.target != this;
        }).filter(function () {
            var _47 = $.data(this, "__droppable").options.accept;
            if (_47) {
    ...
    function _49(e) {
        ...
        _4a.droppables.each(function () {
            var _4c = $(this);
            if (_4c.__droppable("options").disabled) {
                return;
            }
            var p2 = _4c.offset();
    ...
    function _4d(e) {
        ...
        function _52() {
            ...
            _4f.droppables.each(function () {
                var _56 = $(this);
                if (_56.__droppable("options").disabled) {
                    return;
                }
                var p2 = _56.offset();
...
(function ($) {
    function _68(_69) {
        $(_69).addClass("__droppable");
        $(_69).bind("_dragenter", function (e, _6a) {
            $.data(_69, "__droppable").options.onDragEnter.apply(_69, [e, _6a]);
        });
        $(_69).bind("_dragleave", function (e, _6b) {
            $.data(_69, "__droppable").options.onDragLeave.apply(_69, [e, _6b]);
        });
        $(_69).bind("_dragover", function (e, _6c) {
            $.data(_69, "__droppable").options.onDragOver.apply(_69, [e, _6c]);
        });
        $(_69).bind("_drop", function (e, _6d) {
            $.data(_69, "__droppable").options.onDrop.apply(_69, [e, _6d]);
        });
    };
    $.fn.__droppable = function (_6e, _6f) {
        if (typeof _6e == "string") {
            return $.fn.__droppable.methods[_6e](this, _6f);
        }
        _6e = _6e || {};
        return this.each(function () {
            var _70 = $.data(this, "__droppable");
            if (_70) {
                $.extend(_70.options, _6e);
            } else {
                _68(this);
                $.data(this, "__droppable", {options: $.extend({}, $.fn.__droppable.defaults, $.fn.__droppable.parseOptions(this), _6e)});
            }
        });
    };
    $.fn.__droppable.methods = {
        options: function (jq) {
            return $.data(jq[0], "__droppable").options;
        }, enable: function (jq) {
            return jq.each(function () {
                $(this).__droppable({disabled: false});
            });
        }, disable: function (jq) {
            return jq.each(function () {
                $(this).__droppable({disabled: true});
            });
        }
    };
    $.fn.__droppable.parseOptions = function (_71) {
        var t = $(_71);
        return $.extend({}, $.parser.parseOptions(_71, ["accept"]), {disabled: (t.attr("disabled") ? true : undefined)});
    };
    $.fn.__droppable.defaults = {
...
(function ($) {
    ...
    function _ef(_f0) {
        ...
        _f1.disabledNodes = [];
        _f2.dnd = true;
        _f3.find("div.tree-node").__draggable({
            disabled: false, revert: true, cursor: "pointer", proxy: function (_f4) {
                ...
                for (var i = 0; i < _f1.disabledNodes.length; i++) {
                    $(_f1.disabledNodes[i]).__droppable("enable");
                }
                _f1.disabledNodes = [];
...
(function ($) {
    ...
    function _296(_297) {
        ...
        _298.window.__draggable({
            handle: ">div.panel-header>div.panel-title",
            disabled: _298.options.__draggable == false,
            onBeforeDrag: function (e) {
                if (_298.mask) {
        ...
        _298.window.__resizable({
            disabled: _298.options.__resizable == false, onStartResize: function (e) {
                _299(e);
            }, onResize: function (e) {
                _29a(e);
                return false;
...
(function ($) {
    ...
    function _3ff(_400, _401, _402) {
        ...
        _403.__resizable({disabled: (!_402)});
        _3b0(_400);
    };
...
(function ($) {
    ...
    function _6a4(_6a5) {
        ...
        _6aa.each(function () {
            $(this).__resizable({
                handles: _6ab,
                disabled: ($(this).attr("__resizable") ? $(this).attr("__resizable") == "false" : false),
                minWidth: 25,
                onStartResize: function (e) {
                    _6a6.resizing = true;
...
(function ($) {
    ...
    $.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        fitColumns: true,
        loadMsg: "",
        frozenColumns: [[{field: "f", width: 16, __resizable: false}]],
...
(function ($) {
    ...
    function _be2(_be3) {
        ...
        _be5.find("a.slider-handle").__draggable({
