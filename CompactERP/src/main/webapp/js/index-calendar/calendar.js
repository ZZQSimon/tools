    ...
    Calendar.prototype = {
        ...
        renderDOM: function () { // 渲染DOM
            ...
            var _titleStr = '<a href="#" class="title"></a>' +
                ...
                '<div class="arrow">' +
                '<span class="arrow-prev"><i class="fa fa-caret-up"></i></span>' +
                '<span class="arrow-next"><i class="fa fa-caret-down"></i></span>' +
                '</div>';
            ...
            for (var i = 0; i < 6; i++) {
                _dateStr += '<li class="item"><div>26</div></li>' +
                    '<li class="item"><div>26</div></li>' +
                    '<li class="item"><div>26</div></li>' +
                    '<li class="item"><div>26</div></li>' +
                    '<li class="item"><div>26</div></li>' +
                    '<li class="item"><div>26</div></li>' +
        ...
        inital: function () { // 初始化
            ...
            this.$calendarDate_item = this.$calendar_date.find('.item div');
